...
\begin{tikzpicture}[x=1em, y=1em,
        ...
        % --- EIXOS ---
        \node[font=\bfseries, PrintColor, anchor=center, align=center] at ($(botC)+(0,-1)$)
            {$\boldsymbol{a}$};
        \draw[PrintColor, thick, -{Stealth[length={0.7em}, width={0.5em}]}]
            ($(botRm) + (0,-1)$) -- ($(botRm) + (4,-1)$)
        ...
        \node[font=\bfseries, PrintColor, anchor=center, align=center, rotate=90] at ($(leftC)+(-1,0)$)
            {$\boldsymbol{b}$};
        \draw[PrintColor, thick, -{Stealth[length={0.7em}, width={0.5em}]}]
