...
\begin{tikzpicture}[x=1em, y=1em]
    ...
    \begin{scope}[shift={(0,5)}]
        \node[font=\large\bfseries] at (0,10em) {Higher-order interactions};
...
\begin{tikzpicture}[x=1em, y=1em]
    ...
    \begin{scope}[shift={(0,-13)}]
        \node[font=\large\bfseries] at (0,10em) {Simplicial Complex};
...
\begin{tikzpicture}[x=1em, y=1em]
    ...
    \begin{scope}[shift={(0,3)}]
        \node[font=\large\bfseries] at (0,12em) {Higher-order network};
...
\begin{tikzpicture}[x=1em, y=1em]
    ...
    \begin{scope}[shift={(0,-13)}]
        \node[font=\large\bfseries] at (0,12em) {Simplicial Complex};
        \begin{scope}[shift={(-4.5*\Xlim,\Ylim)}, name prefix=node-]
            \coordinate (1) at (0,\Ylim);
            \coordinate (2) at (\Xlim,0);
            \coordinate (3) at (2*\Xlim,\Ylim);
