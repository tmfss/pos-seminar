...
\NewDocumentCommand{\DrawPolyadic}{O{0} O{7} O{Polyadic}}{
    ...
    \begin{scope}[shift={(#1,0)}]
        ...
        \node[PrintColor, font=\bfseries] at (0,-2em) {#3};
    \end{scope}
}
...
\NewDocumentCommand{\DrawPair}{O{0} O{Polygon} O{Red}}{
    ...
    \begin{scope}[shift={(#1,0)}]
        ...
        \node[PrintColor, font=\bfseries] at (0,-2em) {#2};
    \end{scope}
}
...
\begin{tikzpicture}[x=1em, y=1em]
    ...
    \begin{scope}[shift={(0,5)}]
        \node[PrintColor,  font=\large\bfseries] at (0,10em) {Higher-order interactions};
...
\begin{tikzpicture}[x=1em, y=1em]
    ...
    \begin{scope}[shift={(0,-13)}]
        \node[PrintColor,  font=\large\bfseries] at (0,10em) {All-to-all pair approximation};
        \DrawPair[-24][$K_2$]
...
\begin{tikzpicture}[x=1em, y=1em]
    ...
    \begin{scope}[shift={(0,3)}]
        \node[PrintColor,  font=\large\bfseries] at (0,12em) {Higher-order network};
...
\begin{tikzpicture}[x=1em, y=1em]
    ...
    \begin{scope}[shift={(0,-13)}]
        \node[PrintColor,  font=\large\bfseries] at (0,12em) {All-to-all pair approximation};
        \begin{scope}[shift={(-4.5*\Xlim,\Ylim)}, name prefix=node-]
            \coordinate (1) at (0,\Ylim);
            \coordinate (2) at (\Xlim,0);
            \coordinate (3) at (2*\Xlim,\Ylim);
