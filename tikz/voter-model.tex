...
\begin{scope}[shift={(-13,0)}, on background layer]
    \draw[LBlue, opacity=0.5, line cap=round, line join=round, line width=3.6em ] (A1-center) -- (A1-west-agent);
\end{scope}
...
\draw[DBlue,-{Stealth[length={1.5em}, width={1em}]}] ([shift={(35:3em)}]A1-center) parabola bend (0,3.5)  ([shift={(145:3em)}]A2-center);
\node[text=DBlue, font=\bfseries] at (0,4.5) {Agente copia a opinião};
