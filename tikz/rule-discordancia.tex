...
\node[text=DBlue, font=\bfseries, anchor=south, align=center] at (0,6) {Agente muda de opinião\\ com probabilidade $\boldsymbol{\varepsilon}$};

\draw[DBlue,-{Stealth[length={1.5em}, width={1em}]}] ([shift={(-35:3em)}]A1-center) to[out=-35,in=-180]  (A3-left);
\node[text=DBlue, font=\bfseries, anchor=north, align=center] at (-6,-6) {Agente permanece\\ com probabilidade $\boldsymbol{1-\varepsilon}$};
